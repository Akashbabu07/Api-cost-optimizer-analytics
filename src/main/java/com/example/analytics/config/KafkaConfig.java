...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ApiMetricEvent> consumerFactory() {
        JsonDeserializer<ApiMetricEvent> deserializer =
                new JsonDeserializer<>(ApiMetricEvent.class, false); // false = ignore type headers
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ApiMetricEvent>
